...
$mail->addAddress('vijayanandextra@gmail.com'); // Add the first recipient email address
$mail->addAddress('unicornbusniessconsultants.in@gmail.com'); // Add the second recipient email address
